...
//	For porting boost to genode, we're manually 'undefining'
//	BOOST_ASIO_HAS_KQUEUE to BOOST_ASIO_HAS_NOT_KQUEUE
//  This way, reactor.hpp will pick the default select_reactor.hpp
// 	This file goes into boost/asio/detail/config.hpp
...
#   define BOOST_ASIO_HAS_NOT_KQUEUE 1
